...
# Token secret is printed once; capture it and store in Android Keystore.
...
echo ""
echo "IMPORTANT: Copy the token secret above into Stackward immediately."
echo "It cannot be retrieved again. Store in Android Keystore only."
